...
export default function TitleInput({ label, text, setValue, autoFocus }) {
    ...
    const handleTextFieldChange = useCallback(
        (value) => {
            ...
            //            value = value.replace(/[^A-Za-z0-9_ー_ぁ-んァ-ヶ亜-黑]+/ig, '');
            // make sure there is no half-width character
